class DocumentsController < ApplicationController
  ...
  def doc_pdf
    ...
    #url_edifici = Rails.root.to_s + '/edificis/' + @edifici.id.to_s + '/documents/vista_pdf_edifici_nou?locale=ca'
    kit = PDFKit.new('/documents/vista_pdf_edifici_nou?locale=ca')
