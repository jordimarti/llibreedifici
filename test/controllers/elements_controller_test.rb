...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { edifici_id: @element.edifici_id, nom_element: @element.nom_element, sistema_element: @element.sistema_element }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { edifici_id: @element.edifici_id, nom_element: @element.nom_element, sistema_element: @element.sistema_element }
    assert_redirected_to element_path(assigns(:element))
  end
